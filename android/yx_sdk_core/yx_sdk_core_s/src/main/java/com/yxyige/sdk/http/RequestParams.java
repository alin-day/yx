...
public class RequestParams implements Serializable {
     ...
     */
    public HttpEntity getEntity(com.yxyige.sdk.http.ResponseHandlerInterface progressHandler) throws IOException {
        if (useJsonStreamer) {
    ...
    private HttpEntity createJsonStreamerEntity(com.yxyige.sdk.http.ResponseHandlerInterface progressHandler) throws IOException {
        com.yxyige.sdk.http.JsonStreamerEntity entity = new com.yxyige.sdk.http.JsonStreamerEntity(progressHandler,
    ...
    private HttpEntity createMultipartEntity(com.yxyige.sdk.http.ResponseHandlerInterface progressHandler) throws IOException {
