...
public class PayCallBackActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            int ret = UPPayAssistEx.startPay(PayCallBackActivity.this, null,
                    null, tn, mMode);
                        ...
                        new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog,
                                ...
                                boolean install = installAssetsApk(
                                        PayCallBackActivity.this, str);
                                if (!install)
                                    Toast.makeText(PayCallBackActivity.this,
                                            "安装失败，请稍后再试或选择其他支付方式",
            ...
            e.printStackTrace();
            Toast.makeText(PayCallBackActivity.this, "支付失败，请稍后再试或选择其他支付方式",
                    Toast.LENGTH_SHORT).show();
        }
    }
        ...
        if (bundle != null) {
            ...
            if ("success".equalsIgnoreCase(str)) {
                ...
                if (SDKManager.payListener != null) {
                    ...
                    ViewController.showToast(PayCallBackActivity.this, msg);
                }
